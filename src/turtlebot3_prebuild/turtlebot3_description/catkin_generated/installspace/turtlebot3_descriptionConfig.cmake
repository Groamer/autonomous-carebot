...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot3_description_SOURCE_PREFIX /home/groamer/afstuderen_tom_remeeus/src/turtlebot3_prebuild/turtlebot3_description)
  set(turtlebot3_description_DEVEL_PREFIX /home/groamer/afstuderen_tom_remeeus/src/devel)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_description' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
