...
if("FALSE" STREQUAL "TRUE")
  set(turtlebot3_gazebo_SOURCE_PREFIX /home/groamer/afstuderen_tom_remeeus/src/turtlebot3_prebuild/turtlebot3_gazebo)
  set(turtlebot3_gazebo_DEVEL_PREFIX /home/groamer/afstuderen_tom_remeeus/src/devel)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/usr/local/${idir}'.  ${_report}")
    endif()
